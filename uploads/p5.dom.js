 ...
 * <a href="https://github.com/processing/p5.js/wiki/Beyond-the-canvas" target="_blank" rel="noopener">
 * beyond the canvas tutorial</a> for a full overview of how this addon works.
 *
 * </p><p>Methods and properties shown in black are part of the p5.js core, items in
 * blue are part of the p5.dom library. You will need to include an extra file
 * in order to access the blue functions. See the
 * <a href="http://p5js.org/libraries/#using-a-library" target="_blank" rel="noopener">using a library</a>
 * section for information on how to include this library. p5.dom comes with
 * <a href="http://p5js.org/download" target="_blank" rel="noopener">p5 complete</a> or you can download the single file
 * <a href="https://raw.githubusercontent.com/lmccart/p5.js/master/lib/addons/p5.dom.js" target="_blank" rel="noopener">
 * here</a>.</p>
 * <p>See <a href="https://github.com/processing/p5.js/wiki/Beyond-the-canvas" target="_blank" rel="noopener">tutorial: beyond the canvas</a>
...
(function(root, factory) {
   ...
   * different formats. See <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Supported_media_formats" target="_blank" rel="noopener">this
  ...
  /**
   * </p><p>Creates a new &lt;video&gt; element that contains the audio/video feed
   * from a webcam. This can be drawn onto the canvas using video().</p>
   * <p>More specific properties of the feed can be passing in a Constraints object.
   * See the
   * <a href="http://w3c.github.io/mediacapture-main/getusermedia.html#media-track-constraints" target="_blank" rel="noopener"> W3C
   ...
   * or on HTTPS. Learn more <a href="http://stackoverflow.com/questions/34197653/getusermedia-in-chrome-47-without-using-https" target="_blank" rel="noopener">here</a>
   * and <a href="https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia" target="_blank" rel="noopener">here</a>.</p>
   *
  ...
  p5.MediaElement = function(elt, pInst) {
     ...
     *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= height)="" {="" *="" show="" our="" p5.mediaelement's="" src="" field="" alert(ele.src);="" }="" <="" code=""></=></=></code></div>
     */
   ...
   *   //here we test if the mouse is over the
   *   //canvas element when it's clicked
   *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= height)="" {="" *="" here="" we="" call="" the="" play()="" function="" on="" p5.mediaelement="" created="" above.="" this="" will="" start="" audio="" sample.="" ele.play();="" background(200);="" text('you="" clicked="" play!',="" width="" 2,="" height="" 2);="" }="" <="" code=""></=></=></code></div>
   */
   ...
   *   //here we test if the mouse is over the
   *   //canvas element when it's clicked
   *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= 0="" height)="" {="" *="" background(200);="" if="" (sampleisplaying)="" the="" sample="" is="" currently="" playing="" calling="" stop()="" function="" on="" our="" p5.mediaelement="" will="" stop="" it="" and="" reset="" its="" current="" time="" to="" (i.e.="" start="" at="" beginning="" next="" you="" play="" it)="" ele.stop();="" sampleisplaying="false;" text('click="" play!',="" width="" 2,="" height="" 2);="" }="" else="" loop sound="" element="" until="" we="" call="" ele.stop()="" it.="" ele.loop();="" stop!',="" <="" code=""></=></=></code></div>
   */
   ...
   *   //here we test if the mouse is over the
   *   //canvas element when it's clicked
   *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= height)="" {="" *="" background(200);="" if="" (sampleisplaying)="" calling="" pause()="" on="" our="" p5.mediaelement="" will="" stop="" it="" playing,="" but="" when="" we="" call="" the="" loop()="" or="" play()="" functions="" sample="" start="" from="" where="" paused="" it.="" ele.pause();="" sampleisplaying="false;" text('click="" to="" resume!',="" width="" 2,="" height="" 2);="" }="" else="" loop sound="" element="" until="" ele.pause()="" ele.loop();="" pause!',="" <="" code=""></=></=></code></div>
   */
   ...
   *   //here we test if the mouse is over the
   *   //canvas element when it's clicked
   *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= height)="" {="" *="" background(200);="" if="" (!sampleislooping)="" loop our="" sound="" element="" until="" we="" call="" ele.stop()="" on="" it.="" ele.loop();="" sampleislooping="true;" text('click="" to="" stop!',="" width="" 2,="" height="" 2);="" }="" else="" ele.stop();="" loop!',="" <="" code=""></=></=></code></div>
   */
   ...
   *   //here we test if the mouse is over the
   *   //canvas element when it's clicked
   *   if (mouseX >= 0 && mouseX <= width="" &&="" mousey="">= 0 && mouseY <= height)="" {="" *="" background(200);="" if="" (sampleisplaying)="" ele.noloop();="" text('no="" more="" loops!',="" width="" 2,="" height="" 2);="" }="" else="" ele.loop();="" sampleisplaying="true;" text('click="" to="" stop="" looping!',="" <="" code=""></=></=></code></div>
   *
   */
