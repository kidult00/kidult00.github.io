 ...
 *  <br><br>
 *  p5.sound is on <a href="https://github.com/therewasaguy/p5.sound/" target="_blank" rel="noopener">GitHub</a>.
 *  Download the latest version
 *  <a href="https://github.com/therewasaguy/p5.sound/blob/master/lib/p5.sound.js" target="_blank" rel="noopener">here</a>.
 *
 *  @module p5.sound
 *  @submodule p5.sound
 *  @for p5.sound
...
helpers = function () {
   ...
   *  <a href="http://media.io/" target="_blank" rel="noopener">Here</a> is a free online file
   *  converter.
   *
   *  @method soundFormats
        ...
        if (p5.prototype.isFileSupported(extTest)) {
          ...
          for (var i = 0; i < p5sound.extensions.length; i++) {
            ...
            if (supported) {
              ...
              for (var i = 1; i <= pathsplit.length="" -="" 2;="" i++)="" {="" var="" p="pathSplit[i];" pathcore="" +="." p;="" }="" path="pathCore" ;="" break;="" else="" for="" (var="" i="0;" <="" p5sound.extensions.length;="" extension="p5sound.extensions[i];" supported="p5.prototype.isFileSupported(extension);" if="" (supported)="" '.'="" extension;="" (typeof="" paths="==" 'object')="" paths.length;="" console.log('.'+extension="" '="" is="" by="" your="" browser.');="" return="" path;="" };="" **="" *="" used="" osc="" and="" env="" to="" chain="" signal="" math="" p5.prototype._mathchain="function" (o,="" math,="" thischain,="" nextchain,="" type)="" this="" type="" of="" already="" exists="" in="" the="" chain,="" replace="" it="" o.mathops)="" (o.mathops[i]="" instanceof="" o.mathops[i].dispose();="" thischain="i;" (thischain="" o.mathops.length="" 1)="" nextchain="o.mathOps[i" 1];="" o.mathops[thischain="" 1].disconnect();="" 1].connect(math);="" math.connect(nextchain);="" o.mathops[thischain]="math;" o;="" miditofreq:="" p5.prototype.miditofreq="" }(master);="" errorhandler;="" 'use="" strict';="" errorhandler="function" ()="" helper="" function="" generate="" an="" error="" with="" a="" custom="" stack="" trace="" that="" points="" sketch="" removes="" other="" parts="" trace.="" @private="" @class="" customerror="" @constructor="" @param="" {string}="" name="" errortrace="" failedpath="" file="" failed="" load="" @property="" message="" back="" line="" user's="" sketch.="" note:="" edits="" out="" within="" p5.js="" p5.sound.="" originalstack="" unedited,="" original="" @return="" {error}="" returns="" object="" (name,="" errortrace,="" failedpath)="" err="new" error();="" tempstack,="" splitstack;="" err.name="name;" err.originalstack="err.stack" errortrace;="" tempstack="err.stack" err.failedpath="failedPath;" only="" print="" part="" refers="" user="" code:="" splitstack="tempStack.split('\n');" (ln)="" !ln.match(="" (p5.|native="" code|globalinit)="" g);="" });="" err.stack="splitStack.join('\n');" err;="" customerror;="" }();="" panner;="" panner="function" p5sound="master;" ac="p5sound.audiocontext;" stereo="" there="" node="" use="" ac.createstereopanner="" !="=" 'undefined')="" p5.panner="function" (input,="" output)="" this.stereopanner="this.input" =="" ac.createstereopanner();="" input.connect(this.stereopanner);="" this.stereopanner.connect(output);="" p5.panner.prototype.pan="function" (val,="" tfromnow)="" time="tFromNow" ||="" 0;="" t="ac.currentTime" time;="" this.stereopanner.pan.linearramptovalueattime(val,="" t);="" not="" implemented="" because="" stereopanner="" does="" require="" will="" automatically="" convert="" single="" channel="" or="" multichannel="" stereo.="" tested="" stereo,="" (="">2) multichannel
...
soundfile = function () {
   ...
   *  <a href="https://github.com/processing/p5.js/wiki/Local-server" target="_blank" rel="noopener">
  ...
  */
  ...
  p5.SoundFile.prototype._onTimeUpdate = function (position) {
    ...
    for (var i = 0; i < cueLength; i++) {
      ...
      var val = cue.val;
      if (this._prevTime < callbackTime && callbackTime <= playbacktime)="" {="" pass="" the="" scheduled="" callbacktime="" as="" parameter="" to="" callback="" cue.callback(val);="" }="" this._prevtime="playbackTime;" };="" }(sndcore,="" errorhandler,="" master,="" helpers);="" var="" amplitude;="" 'use="" strict';="" amplitude="function" ()="" p5sound="master;" **="" *="" measures="" volume="" between="" 0.0="" and="" 1.0.="" listens="" all="" by="" default,="" or="" use="" setinput()="" listen="" a="" specific="" sound="" source.="" accepts="" an="" optional="" smoothing="" value,="" which="" defaults="" 0.="" @class="" p5.amplitude="" @constructor="" @param="" {number}="" [smoothing]="" .999="" smooth="" readings="" (defaults="" 0)="" @example="" <div=""><code>
...
fft = function () {
   ...
   *  isolates individual
   *  <a href="https://en.wikipedia.org/wiki/Audio_frequency" target="_blank" rel="noopener">
...
Tone_core_Param = function (Tone) {
  ...
  Tone.Param.prototype.setValueAtTime = function (value, time) {
    ...
    if (time <= 2016="" this.now()="" +="" this.blocktime)="" {="" this._param.value="value;" }="" else="" this._param.setvalueattime(value,="" time);="" return="" this;="" };="" tone.param.prototype.setramppoint="function" (now)="" now="this.defaultArg(now," this.now());="" var="" currentval="this._param.value;" if="" (currentval="==" 0)="" this._param.setvalueattime(currentval,="" now);="" tone.param.prototype.linearramptovalueattime="function" (value,="" endtime)="" value="this._fromUnits(value);" this._param.linearramptovalueattime(value,="" this.toseconds(endtime));="" tone.param.prototype.exponentialramptovalueattime="function" value);="" this._param.exponentialramptovalueattime(value,="" tone.param.prototype.exponentialramptovalue="function" ramptime,="" starttime)="" starttime="this.toSeconds(startTime);" this.setramppoint(starttime);="" this.exponentialramptovalueattime(value,="" this.toseconds(ramptime));="" tone.param.prototype.linearramptovalue="function" this.linearramptovalueattime(value,="" tone.param.prototype.settargetattime="function" starttime,="" timeconstant)="" timeconstant="Math.max(this._minOutput," timeconstant);="" this._param.settargetattime(value,="" this.toseconds(starttime),="" tone.param.prototype.setvaluecurveattime="function" (values,="" duration)="" for="" (var="" i="0;" <="" values.length;="" i++)="" values[i]="this._fromUnits(values[i]);" this._param.setvaluecurveattime(values,="" this.toseconds(duration));="" tone.param.prototype.cancelscheduledvalues="function" (starttime)="" this._param.cancelscheduledvalues(this.toseconds(starttime));="" tone.param.prototype.rampto="function" ramptime="this.defaultArg(rampTime," 0);="" (this.units="==" tone.type.frequency="" ||="" this.units="==" tone.type.bpm="" tone.type.decibels)="" this.exponentialramptovalue(value,="" starttime);="" this.linearramptovalue(value,="" object.defineproperty(tone.param.prototype,="" 'lfo',="" get:="" function="" ()="" this._lfo;="" });="" tone.param.prototype.dispose="function" tone.prototype.dispose.call(this);="" this._param="null;" (this._lfo)="" this._lfo.dispose();="" this._lfo="null;" tone.param;="" }(tone_core_tone);="" **="" tone.js="" module="" by="" yotam="" mann,="" mit="" license="" http:="" opensource.org="" licenses="" tone_core_gain;="" tone_core_gain="function" (tone)="" 'use="" strict';="" (window.gainnode="" &&="" !audiocontext.prototype.creategain)="" audiocontext.prototype.creategain="AudioContext.prototype.createGainNode;" tone.gain="function" options="this.optionsObject(arguments," [="" 'gain',="" 'units'="" ],="" tone.gain.defaults);="" this.input="this.output" =="" this._gainnode="this.context.createGain();" this.gain="new" tone.param({="" 'param':="" this._gainnode.gain,="" 'units':="" options.units,="" 'value':="" options.gain,="" 'convert':="" options.convert="" this._readonly('gain');="" tone.extend(tone.gain);="" tone.gain.defaults="{" 'gain':="" 1,="" true="" tone.gain.prototype.dispose="function" tone.param.prototype.dispose.call(this);="" this._gainnode.disconnect();="" this._writable('gain');="" this.gain.dispose();="" tone.prototype.createinsouts="function" (inputs,="" outputs)="" (inputs="==" 1)="" tone.gain();=""> 1) {
      this.input = new Array(inputs);
    }
    if (outputs === 1) {
...
oscillator = function () {
   ...
   *  specific oscillator: <a href="/reference/#/p5.SinOsc">p5.SinOsc</a>, <a *="" href="/reference/#/p5.TriOsc">p5.TriOsc</a>, <a *="" href="/reference/#/p5.SqrOsc">p5.SqrOsc</a>, or <a *="" href="/reference/#/p5.SawOsc">p5.SawOsc</a>.
   *  </p>
   *
   *  @class p5.Oscillator
   *  @constructor
...
Tone_core_Timeline = function (Tone) {
  ...
  Tone.Timeline.prototype._search = function (time) {
    ...
    var len = this._timeline.length;
    var end = len;
    if (len > 0 && this._timeline[len - 1].time <= time)="" {="" return="" len="" -="" 1;="" }="" while="" (beginning="" <="" end)="" var="" midpoint="Math.floor(beginning" +="" (end="" beginning)="" 2);="" event="this._timeline[midPoint];" nextevent="this._timeline[midPoint" 1];="" if="" (event.time="==" for="" (var="" i="midPoint;" this._timeline.length;="" i++)="" testevent="this._timeline[i];" (testevent.time="==" midpoint;="" else="" time="" &&="" nextevent.time=""> time) {
        return midPoint;
...
Tone_signal_TimelineSignal = function (Tone) {
  ...
  Tone.TimelineSignal.prototype._curveInterpolate = function (start, curve, duration, time) {
    ...
    if (time >= start + duration) {
      return curve[len - 1];
    } else if (time <= start)="" {="" return="" curve[0];="" }="" else="" var="" progress="(time" -="" duration;="" lowerindex="Math.floor((len" 1)="" *="" progress);="" upperindex="Math.ceil((len" lowerval="curve[lowerIndex];" upperval="curve[upperIndex];" if="" (upperindex="==" lowerindex)="" lowerval;="" this._linearinterpolate(lowerindex,="" lowerval,="" upperindex,="" upperval,="" (len="" 1));="" };="" tone.timelinesignal.prototype.dispose="function" ()="" tone.signal.prototype.dispose.call(this);="" tone.param.prototype.dispose.call(this);="" this._events.dispose();="" this._events="null;" tone.timelinesignal;="" }(tone_core_tone,="" tone_signal_signal);="" env;="" 'use="" strict';="" env="function" p5sound="master;" add="Tone_signal_Add;" mult="Tone_signal_Multiply;" scale="Tone_signal_Scale;" timelinesignal="Tone_signal_TimelineSignal;" tone="Tone_core_Tone;" tone.setcontext(p5sound.audiocontext);="" **="" <p="">Envelopes are pre-defined amplitude distribution over time.
   *  Typically, envelopes are used to control the output volume
   *  of an object, a series of fades referred to as Attack, Decay,
   *  Sustain and Release (
   *  <a href="https://upload.wikimedia.org/wikipedia/commons/e/ea/ADSR_parameter.svg" target="_blank" rel="noopener">ADSR</a>
   *  ). Envelopes can also control other Web Audio Parameters—for example, a p5.Env can
   *  control an Oscillator's frequency like this: <code>osc.freq(env)</code>.<p></p>
   ...
   *  <a href="https://en.wikipedia.org/wiki/Synthesizer#/media/File:ADSR_parameter.svg" target="_blank" rel="noopener">
   *  ADSR envelope
   *  </a>.
   *
   *  @method  setADSR
  ...
  //
  //  Set the <a href="https://en.wikipedia.org/wiki/RC_time_constant" target="_blank" rel="noopener">
  ...
  p5.Env.prototype.checkExpInput = function (value) {
    if (value <= 0)="" {="" value="1e-8;" }="" return="" value;="" };="" **="" *="" play="" tells="" the="" envelope="" to="" start="" acting="" on="" a="" given="" input.="" if="" input="" is="" p5.sound="" object="" (i.e.="" audioin,="" oscillator,="" soundfile),="" then="" env="" will="" control="" its="" output="" volume.="" envelopes="" can="" also="" be="" used="" any="" <a="" href="
   ...
   *  as <a href="https://en.wikipedia.org/wiki/RC_time_constant" target="_blank" rel="noopener">
   *  time constants</a> for simple exponential ramps.
...
audioin = function () {
   ...
   *  feedback.</p>
   *
   *  <p><em>Note: This uses the <a href="http://caniuse.com/stream" target="_blank" rel="noopener">getUserMedia/
   ...
   * for <a title="MediaDevices.enumerateDevices() - Web APIs | MDN" target="_blank" href="*" "https:="" developer.mozilla.org="" en-us="" docs="" web="" api="" mediadevices="" enumeratedevices"="" *=""> and it returns a Promise.
   *
   * @method  getSources
   ...
   *  <a title="MediaDevices.enumerateDevices() - Web APIs | MDN" target="_blank" href="*" "https:="" developer.mozilla.org="" en-us="" docs="" web="" api="" mediadevices="" enumeratedevices"="" *="">navigator.mediaDevices.enumerateDevices()</a>.<br>
   *
   *  @method setSource
...
Tone_signal_GreaterThanZero = function (Tone) {
  ...
  Tone.GreaterThanZero = function () {
    this._thresh = this.output = new Tone.WaveShaper(function (val) {
      if (val <= 2016="" 0)="" {="" return="" 0;="" }="" else="" 1;="" },="" 127);="" this._scale="this.input" =="" new="" tone.multiply(10000);="" this._scale.connect(this._thresh);="" };="" tone.extend(tone.greaterthanzero,="" tone.signalbase);="" tone.greaterthanzero.prototype.dispose="function" ()="" tone.prototype.dispose.call(this);="" this._scale.dispose();="" this._thresh.dispose();="" this._thresh="null;" this;="" tone.greaterthanzero;="" }(tone_core_tone,="" tone_signal_signal,="" tone_signal_multiply);="" **="" tone.js="" module="" by="" yotam="" mann,="" mit="" license="" http:="" opensource.org="" licenses="" var="" tone_signal_greaterthan;="" tone_signal_greaterthan="function" (tone)="" 'use="" strict';="" tone.greaterthan="function" (value)="" this.createinsouts(2,="" 0);="" this._param="this.input[0]" tone.subtract(value);="" this.input[1]="this._param.input[1];" this._gtz="this.output" tone.greaterthanzero();="" this._param.connect(this._gtz);="" tone.extend(tone.greaterthan,="" tone.signal);="" tone.greaterthan.prototype.dispose="function" this._param.dispose();="" this._gtz.dispose();="" tone.greaterthan;="" tone_signal_greaterthanzero,="" tone_signal_subtract);="" tone_signal_abs;="" tone_signal_abs="function" tone.abs="function" this._abs="this.input" this.output="new" tone.waveshaper(function="" (val)="" if="" (val="==" math.abs(val);="" tone.extend(tone.abs,="" tone.abs.prototype.dispose="function" this._abs.dispose();="" tone.abs;="" tone_signal_waveshaper);="" tone_signal_modulo;="" tone_signal_modulo="function" tone.modulo="function" (modulus)="" this.createinsouts(1,="" this._shaper="new" tone.waveshaper(math.pow(2,="" 16));="" this._multiply="new" tone.multiply();="" this._subtract="this.output" tone.subtract();="" this._modsignal="new" tone.signal(modulus);="" this.input.fan(this._shaper,="" this._subtract);="" this._modsignal.connect(this._multiply,="" 0,="" this._shaper.connect(this._multiply,="" 1);="" this._multiply.connect(this._subtract,="" this._setwaveshaper(modulus);="" tone.extend(tone.modulo,="" tone.modulo.prototype._setwaveshaper="function" (mod)="" this._shaper.setmap(function="" multiple="Math.floor((val" +="" 0.0001)="" mod);="" multiple;="" });="" object.defineproperty(tone.modulo.prototype,="" 'value',="" get:="" function="" this._modsignal.value;="" set:="" this._modsignal.value="mod;" this._setwaveshaper(mod);="" tone.modulo.prototype.dispose="function" this._shaper.dispose();="" this._multiply.dispose();="" this._subtract.dispose();="" this._modsignal.dispose();="" tone.modulo;="" tone_signal_waveshaper,="" tone_signal_pow;="" tone_signal_pow="function" tone.pow="function" (exp)="" this._exp="this.defaultArg(exp," this._expscaler="this.input" tone.waveshaper(this._expfunc(this._exp),="" 8192);="" tone.extend(tone.pow,="" object.defineproperty(tone.pow.prototype,="" this._exp;="" this._expscaler.setmap(this._expfunc(this._exp));="" tone.pow.prototype._expfunc="function" math.pow(math.abs(val),="" exp);="" tone.pow.prototype.dispose="function" this._expscaler.dispose();="" tone.pow;="" }(tone_core_tone);="" tone_signal_audiotogain;="" tone_signal_audiotogain="function" tone.audiotogain="function" this._norm="this.input" (x)="" (x="" 1)="" 2;="" tone.extend(tone.audiotogain,="" tone.audiotogain.prototype.dispose="function" this._norm.dispose();="" tone.audiotogain;="" tone_signal_expr;="" tone_signal_expr="function" tone.expr="function" expr="this._replacements(Array.prototype.slice.call(arguments));" inputcount="this._parseInputs(expr);" this._nodes="[];" this.input="new" array(inputcount);="" for="" (var="" i="0;" <="" inputcount;="" i++)="" this.input[i]="this.context.createGain();" tree="this._parseTree(expr);" result;="" try="" result="this._eval(tree);" catch="" (e)="" this._disposenodes();="" throw="" error('tone.expr:="" could="" evaluate="" expression:="" '="" expr);="" tone.extend(tone.expr,="" applybinary(constructor,="" args,="" self)="" op="new" constructor();="" self._eval(args[0]).connect(op,="" self._eval(args[1]).connect(op,="" op;="" applyunary(constructor,="" getnumber(arg)="" arg="" ?="" parsefloat(arg)="" :="" undefined;="" literalnumber(arg)="" &&="" arg.args="" parsefloat(arg.args)="" tone.expr._expressions="{" 'value':="" 'signal':="" regexp:="" ^\d+\.\d+|^\d+="" ,="" method:="" (arg)="" sig="new" tone.signal(getnumber(arg));="" sig;="" 'input':="" ^\$\d="" (arg,="" self.input[getnumber(arg.substr(1))];="" 'glue':="" '(':="" ^\(="" ')':="" ^\)="" ',':="" ^,="" 'func':="" 'abs':="" ^abs="" applyunary.bind(this,="" tone.abs)="" 'mod':="" ^mod="" (args,="" modulus="literalNumber(args[1]);" tone.modulo(modulus);="" self._eval(args[0]).connect(op);="" 'pow':="" ^pow="" exp="literalNumber(args[1]);" tone.pow(exp);="" 'a2g':="" ^a2g="" tone.audiotogain();="" 'binary':="" '+':="" ^\+="" precedence:="" 1,="" applybinary.bind(this,="" tone.add)="" '-':="" ^\-="" (args.length="==" applyunary(tone.negate,="" self);="" applybinary(tone.subtract,="" '*':="" ^\*="" tone.multiply)="" 'unary':="" tone.negate)="" '!':="" ^\!="" tone.not)="" tone.expr.prototype._parseinputs="function" (expr)="" inputarray="expr.match(/\$\d/g);" inputmax="0;" (inputarray="" !="=" null)="" inputarray.length;="" inputnum="parseInt(inputArray[i].substr(1))" inputnum);="" inputmax;="" tone.expr.prototype._replacements="function" (args)="" args.length;="" args[i]);="" expr;="" tone.expr.prototype._tokenize="function" position="-1;" tokens="[];" while="" (expr.length=""> 0) {
      expr = expr.trim();
...
filter = function () {
  ...
  p5.Filter = function (type) {
    ...
    /**
        ...
        *  <a href="http://www.w3.org/TR/webaudio/#BiquadFilterNode" target="_blank" rel="noopener">
  ...
  p5.Filter.prototype.freq = function (freq, time) {
    var t = time || 0;
    if (freq <= 1000="" 0)="" {="" freq="1;" }="" if="" (typeof="" 'number')="" this.biquad.frequency.value="freq;" this.biquad.frequency.cancelscheduledvalues(this.ac.currenttime="" +="" 0.01="" t);="" this.biquad.frequency.exponentialramptovalueattime(freq,="" this.ac.currenttime="" 0.02="" else="" (freq)="" freq.connect(this.biquad.frequency);="" return="" this.biquad.frequency.value;="" };="" **="" *="" controls either="" width="" of="" a="" bandpass="" frequency,="" or="" the="" resonance="" low="" highpass="" cutoff="" frequency.="" @method="" res="" @param="" {number}="" filter="" from="" 0.001="" to="" [timefromnow]="" schedule="" this="" event="" happen="" seconds="" now="" @return="" value="" returns="" current="" p5.filter.prototype.res="function" (res,="" time)="" var="" t="time" ||="" 0;="" this.biquad.q.value="res;" this.biquad.q.cancelscheduledvalues(this.ac.currenttime="" this.biquad.q.linearramptovalueattime(res,="" (res)="" res.connect(this.biquad.q);="" this.biquad.q.value;="" gain="" attribute="" biquad="" filter.="" is="" distinctly="" different="" .amp()="" which="" inherited="" p5.effect="" volume="" via="" output="" node="" p5.filter.gain()="" parameter="" node.="" updated="" p5.filter.prototype.gain="function" (gain,="" this.biquad.gain.value="gain;" this.biquad.gain.cancelscheduledvalues(this.ac.currenttime="" this.biquad.gain.linearramptovalueattime(gain,="" (gain)="" gain.connect(this.biquad.gain);="" this.biquad.gain.value;="" toggle="" function.="" switches="" between="" specified="" type="" and="" allpass="" {boolean}="" [toggle="" value]="" p5.filter.prototype.toggle="function" ()="" this._on="!this._on;" (this._on="==" true)="" this.biquad.type="this._untoggledType;" false)="" ;="" this._on;="" set="" p5.filter.="" possible="" types="" include:="" "lowpass"="" (default),="" "highpass",="" "bandpass",="" "lowshelf",="" "highshelf",="" "peaking",="" "notch",="" "allpass".="" settype="" {string}="" p5.filter.prototype.settype="function" (t)="" this._untoggledtype="this.biquad.type;" p5.filter.prototype.dispose="function" remove="" reference="" soundarray="" effect.prototype.dispose.apply(this);="" this.biquad.disconnect();="" this.biquad="undefined;" constructor:="" <code="">new p5.LowPass() Filter.
...
eq = function () {
  ...
  p5.EQ = function (_eqsize) {
    ...
    /**
      ...
      *  To modify any bands, use methods of the <a *="" href="/reference/#/p5.Filter" title="p5.Filter reference">
...
panner3d = function () {
  ...
  var Effect = effect;
  /**
   * Panner3D is based on the <a title="Web Audio Panner docs" href="*" "https:="" developer.mozilla.org="" en-us="" docs="" web="" api="" pannernode"="">
   * Web Audio Spatial Panner Node</a>.
   * This panner is a spatial processing node that allows audio to be positioned
   * and oriented in 3D space.
   *
   * The position is relative to an <a title="Web Audio Listener docs" href="*" "https:="" developer.mozilla.org="" en-us="" docs="" web="" api="" audiolistener"="">
  ...
  p5.Panner3D = function () {
    Effect.call(this);
    /**
     *  <a title="Web Audio Panner docs" href="*" "https:="" developer.mozilla.org="" en-us="" docs="" web="" api="" pannernode"="">
     *  Web Audio Spatial Panner Node</a>
     *
     *  Properties include
     *    -  <a title="w3 spec for Panning Model" *="" href="https://www.w3.org/TR/webaudio/#idl-def-PanningModelType" target="_blank" rel="noopener">panningModel</a>: "equal power" or "HRTF"
     *    -  <a title="w3 spec for Distance Model" *="" href="https://www.w3.org/TR/webaudio/#idl-def-DistanceModelType" target="_blank" rel="noopener">distanceModel</a>: "linear", "inverse", or "exponential"
     *
...
delay = function () {
  ...
  p5.Delay = function () {
     ...
     *  <a href="http://www.w3.org/TR/webaudio/#DelayNode" target="_blank" rel="noopener">
...
reverb = function () {
  ...
  p5.Convolver = function (path, callback, errorCallback) {
     ...
     *  <a href="http://www.w3.org/TR/webaudio/#ConvolverNode" target="_blank" rel="noopener">
...
metro = function () {
  ...
  p5.Metro.prototype.ontick = function (tickTime) {
    ...
    if (elapsedTime - this.tatumTime <= 0="" -0.02)="" {="" return;="" }="" else="" console.log('ok',="" this.syncedparts[0].phrases[0].name);="" this.prevtick="tickTime;" for="" all="" of="" the="" active="" things="" on="" metro:="" var="" self="this;" this.syncedparts.foreach(function="" (thispart)="" if="" (!thispart.isplaying)="" thispart.incrementstep(secondsfromnow);="" each="" synced="" source="" keeps="" track="" its="" own="" beat="" number="" thispart.phrases.foreach(function="" (thisphrase)="" phrasearray="thisPhrase.sequence;" bnum="self.metroTicks" %="" phrasearray.length;="" (phrasearray[bnum]="" !="=" &&="" (self.metroticks="" <="" phrasearray.length="" ||="" !thisphrase.looping))="" thisphrase.callback(secondsfromnow,="" phrasearray[bnum]);="" });="" this.metroticks="" +="1;" this.tickcallback(secondsfromnow);="" };="" p5.metro.prototype.setbpm="function" (bpm,="" ramptime)="" beattime="60" (bpm="" *="" this.tatums);="" now="p5sound.audiocontext.currentTime;" this.tatumtime="beatTime;" ramptime="rampTime" 0;="" this.clock.frequency.setvalueattime(this.clock.frequency.value,="" now);="" this.clock.frequency.linearramptovalueattime(bpm,="" ramptime);="" this.bpm="bpm;" p5.metro.prototype.getbpm="function" ()="" return="" this.clock.getrate()="" this.tatums="" 60;="" p5.metro.prototype._init="function" clear="" existing="" parts,="" add="" only="" this="" one="" p5.metro.prototype.resetsync="function" (part)="" this.syncedparts="[part];" push="" a="" new="" part="" to="" array="" p5.metro.prototype.pushsync="function" this.syncedparts.push(part);="" p5.metro.prototype.start="function" (timefromnow)="" t="timeFromNow" this.clock.start(now="" t);="" this.setbpm(this.bpm);="" p5.metro.prototype.stop="function" this.clock.stop(now="" p5.metro.prototype.beatlength="function" (tatums)="" tatums="" 4;="" }(master,="" tone_core_clock);="" looper;="" 'use="" strict';="" looper="function" p5sound="master;" bpm="120;" **="" set="" global="" tempo,="" in="" beats="" per="" minute,="" p5.parts.="" method="" will="" impact="" @method="" setbpm="" @param="" {number}="" minute="" seconds="" from="" p5.prototype.setbpm="function" (var="" i="" p5sound.parts)="" (p5sound.parts[i])="" p5sound.parts[i].setbpm(bpm,="" <p="">A phrase is a pattern of musical events over time, i.e.
...
soundloop = function () {
  ...
  p5.SoundLoop = function (callback, interval) {
    this.callback = callback;
    /**
       * musicalTimeMode uses <a href="https://github.com/Tonejs/Tone.js/wiki/Time" target="_blank" rel="noopener">Tone.Time</a> convention
    * true if string, false if number
    ...
    this.clock = new Clock({
      'callback': function (time) {
         ...
         */
        if (timeFromNow > 0 && self.iterations <= 1="" 60="" self.maxiterations)="" {="" self.callback(timefromnow);="" }="" },="" 'frequency':="" this._calcfreq()="" });="" };="" **="" *="" start="" the="" loop @method="" @param="" {number}="" [timefromnow]="" schedule="" a="" starting="" time="" p5.soundloop.prototype.start="function" (timefromnow)="" var="" t="timeFromNow" ||="" 0;="" now="p5sound.audiocontext.currentTime;" if="" (!this.isplaying)="" this.clock.start(now="" +="" t);="" this.isplaying="true;" stop="" stopping="" p5.soundloop.prototype.stop="function" (this.isplaying)="" this.clock.stop(now="" pause="" pausing="" p5.soundloop.prototype.pause="function" this.clock.pause(t);="" synchronize="" loops.="" use="" this="" method="" to="" two="" more="" loops="" in="" synchronization="" or="" with="" that="" is="" already="" playing="" will="" implicit="" sync="" explicit="" master="" i.e.="" looptostart.syncedstart(looptosyncwith)="" syncedstart="" {object}="" otherloop="" p5.soundloop="" after="" timefromnow="" seconds="" p5.soundloop.prototype.syncedstart="function" (otherloop,="" timefromnow)="" (!otherloop.isplaying)="" otherloop.clock.start(now="" otherloop.isplaying="true;" else="" (otherloop.isplaying)="" -="" p5sound.audiocontext.currenttime;="" time);="" updates="" frequency="" value,="" reflected="" next="" callback="" @private="" _update="" p5.soundloop.prototype._update="function" ()="" this.clock.frequency.value="this._calcFreq();" calculate="" of="" clock's="" based="" on="" bpm,="" interval,="" and="" timesignature="" _calcfreq="" @return="" new="" clock="" value="" p5.soundloop.prototype._calcfreq="function" mode,="" bpm="" has="" no="" effect="" (typeof="" this._interval="==" 'number')="" this.musicaltimemode="false;" return="" this._interval;="" 'string')="" this._bpm="" this._convertnotation(this._interval)="" (this._timesignature="" 4);="" convert="" notation="" from="" musical="" format="" uses="" <a="" href="https://github.com/Tonejs/Tone.js/wiki/Time">Tone.Time</=></=></=></=></a> convention
   * @private
...
compressor = function () {
  ...
  p5.Compressor = function () {
    Effect.call(this);
    /**
       * The p5.Compressor is built with a <a href="https://www.w3.org/TR/webaudio/#the-dynamicscompressornode-interface" *="" target="_blank" title="W3 spec for Dynamics Compressor Node">Web Audio Dynamics Compressor Node
     *   </a>
...
monosynth = function () {
  ...
  **/
   ...
   *                                 See <a href="https://github.com/Tonejs/Tone.js/wiki/Instruments" target="_blank" rel="noopener">
...
distortion = function () {
  ...
  p5.Distortion = function (amount, oversample) {
     ...
     *  <a href="http://www.w3.org/TR/webaudio/#WaveShaperNode" target="_blank" rel="noopener">
